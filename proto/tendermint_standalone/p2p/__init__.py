...
class PeerInfo(betterproto.Message):
    ...
    inactive: bool = betterproto.bool_field(4)
...
@dataclass(eq=False, repr=False)
class PexAddress(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class PexResponse(betterproto.Message):
    addresses: List["PexAddress"] = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class PexMessage(betterproto.Message):
    pex_request: "PexRequest" = betterproto.message_field(3, group="sum")
    pex_response: "PexResponse" = betterproto.message_field(4, group="sum")
