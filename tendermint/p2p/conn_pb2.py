...
_PACKETMSG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='channel_id', full_name='tendermint.p2p.PacketMsg.channel_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='eof', full_name='tendermint.p2p.PacketMsg.eof', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='data', full_name='tendermint.p2p.PacketMsg.data', index=2,
...
_PACKET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='packet_ping', full_name='tendermint.p2p.Packet.packet_ping', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='packet_pong', full_name='tendermint.p2p.Packet.packet_pong', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='packet_msg', full_name='tendermint.p2p.Packet.packet_msg', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='sum', full_name='tendermint.p2p.Packet.sum',
...
_AUTHSIGMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pub_key', full_name='tendermint.p2p.AuthSigMessage.pub_key', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='sig', full_name='tendermint.p2p.AuthSigMessage.sig', index=1,
...
_AUTHSIGMESSAGE.fields_by_name['pub_key'].message_type = tendermint_dot_crypto_dot_keys__pb2._PUBLICKEY
...
AuthSigMessage = _reflection.GeneratedProtocolMessageType('AuthSigMessage', (_message.Message,), dict(
