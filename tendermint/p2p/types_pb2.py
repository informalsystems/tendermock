...
_NETADDRESS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\336\037\002IP'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_PROTOCOLVERSION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\336\037\003P2P'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_DEFAULTNODEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\336\037\rDefaultNodeID'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_DEFAULTNODEINFOOTHER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\336\037\nRPCAddress'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
NetAddress = _reflection.GeneratedProtocolMessageType('NetAddress', (_message.Message,), dict(
...
ProtocolVersion = _reflection.GeneratedProtocolMessageType('ProtocolVersion', (_message.Message,), dict(
...
DefaultNodeInfo = _reflection.GeneratedProtocolMessageType('DefaultNodeInfo', (_message.Message,), dict(
...
DefaultNodeInfoOther = _reflection.GeneratedProtocolMessageType('DefaultNodeInfoOther', (_message.Message,), dict(
