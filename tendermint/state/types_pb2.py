...
_ABCIRESPONSES = DESCRIPTOR.message_types_by_name['ABCIResponses']
_VALIDATORSINFO = DESCRIPTOR.message_types_by_name['ValidatorsInfo']
_CONSENSUSPARAMSINFO = DESCRIPTOR.message_types_by_name['ConsensusParamsInfo']
_ABCIRESPONSESINFO = DESCRIPTOR.message_types_by_name['ABCIResponsesInfo']
