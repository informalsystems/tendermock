...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('Z7github.com/tendermint/tendermint/proto/tendermint/state'),
  ...
  ,
  dependencies=[gogoproto_dot_gogo__pb2.DESCRIPTOR,tendermint_dot_abci_dot_types__pb2.DESCRIPTOR,tendermint_dot_types_dot_types__pb2.DESCRIPTOR,tendermint_dot_types_dot_validator__pb2.DESCRIPTOR,tendermint_dot_types_dot_params__pb2.DESCRIPTOR,tendermint_dot_version_dot_types__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])
...
_ABCIRESPONSES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='deliver_txs', full_name='tendermint.state.ABCIResponses.deliver_txs', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='end_block', full_name='tendermint.state.ABCIResponses.end_block', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='begin_block', full_name='tendermint.state.ABCIResponses.begin_block', index=2,
...
_VALIDATORSINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='validator_set', full_name='tendermint.state.ValidatorsInfo.validator_set', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_height_changed', full_name='tendermint.state.ValidatorsInfo.last_height_changed', index=1,
...
_CONSENSUSPARAMSINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='consensus_params', full_name='tendermint.state.ConsensusParamsInfo.consensus_params', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='last_height_changed', full_name='tendermint.state.ConsensusParamsInfo.last_height_changed', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ABCIRESPONSESINFO = _descriptor.Descriptor(
  ...
  full_name='tendermint.state.ABCIResponsesInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='abci_responses', full_name='tendermint.state.ABCIResponsesInfo.abci_responses', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height', full_name='tendermint.state.ABCIResponsesInfo.height', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VERSION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='consensus', full_name='tendermint.state.Version.consensus', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='software', full_name='tendermint.state.Version.software', index=1,
...
_STATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='tendermint.state.State.version', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\310\336\037\000'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chain_id', full_name='tendermint.state.State.chain_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='initial_height', full_name='tendermint.state.State.initial_height', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_block_height', full_name='tendermint.state.State.last_block_height', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_block_id', full_name='tendermint.state.State.last_block_id', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='last_block_time', full_name='tendermint.state.State.last_block_time', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='next_validators', full_name='tendermint.state.State.next_validators', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validators', full_name='tendermint.state.State.validators', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_validators', full_name='tendermint.state.State.last_validators', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_height_validators_changed', full_name='tendermint.state.State.last_height_validators_changed', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='consensus_params', full_name='tendermint.state.State.consensus_params', index=10,
      ...
      serialized_options=_b('\310\336\037\000'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_height_consensus_params_changed', full_name='tendermint.state.State.last_height_consensus_params_changed', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_results_hash', full_name='tendermint.state.State.last_results_hash', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='app_hash', full_name='tendermint.state.State.app_hash', index=13,
...
_ABCIRESPONSES.fields_by_name['deliver_txs'].message_type = tendermint_dot_abci_dot_types__pb2._RESPONSEDELIVERTX
_ABCIRESPONSES.fields_by_name['end_block'].message_type = tendermint_dot_abci_dot_types__pb2._RESPONSEENDBLOCK
_ABCIRESPONSES.fields_by_name['begin_block'].message_type = tendermint_dot_abci_dot_types__pb2._RESPONSEBEGINBLOCK
_VALIDATORSINFO.fields_by_name['validator_set'].message_type = tendermint_dot_types_dot_validator__pb2._VALIDATORSET
_CONSENSUSPARAMSINFO.fields_by_name['consensus_params'].message_type = tendermint_dot_types_dot_params__pb2._CONSENSUSPARAMS
_ABCIRESPONSESINFO.fields_by_name['abci_responses'].message_type = _ABCIRESPONSES
_VERSION.fields_by_name['consensus'].message_type = tendermint_dot_version_dot_types__pb2._CONSENSUS
_STATE.fields_by_name['version'].message_type = _VERSION
_STATE.fields_by_name['last_block_id'].message_type = tendermint_dot_types_dot_types__pb2._BLOCKID
_STATE.fields_by_name['last_block_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_STATE.fields_by_name['next_validators'].message_type = tendermint_dot_types_dot_validator__pb2._VALIDATORSET
_STATE.fields_by_name['validators'].message_type = tendermint_dot_types_dot_validator__pb2._VALIDATORSET
_STATE.fields_by_name['last_validators'].message_type = tendermint_dot_types_dot_validator__pb2._VALIDATORSET
_STATE.fields_by_name['consensus_params'].message_type = tendermint_dot_types_dot_params__pb2._CONSENSUSPARAMS
...
ABCIResponsesInfo = _reflection.GeneratedProtocolMessageType('ABCIResponsesInfo', (_message.Message,), dict(
