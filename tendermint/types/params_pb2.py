...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('Z7github.com/tendermint/tendermint/proto/tendermint/types\250\342\036\001'),
...
_VALIDATORPARAMS = _descriptor.Descriptor(
  ...
  serialized_options=_b('\270\240\037\001\350\240\037\001'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_VERSIONPARAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='app', full_name='tendermint.types.VersionParams.app', index=0,
...
VersionParams = _reflection.GeneratedProtocolMessageType('VersionParams', (_message.Message,), dict(
