...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('Z2github.com/tendermint/tendermint/rpc/grpc;coregrpc'),
...
_RESPONSEBROADCASTTX.fields_by_name['check_tx'].message_type = tendermint_dot_abci_dot_types__pb2._RESPONSECHECKTX
_RESPONSEBROADCASTTX.fields_by_name['deliver_tx'].message_type = tendermint_dot_abci_dot_types__pb2._RESPONSEDELIVERTX
